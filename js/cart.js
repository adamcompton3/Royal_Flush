...
products[0] = new Product("001", "Scott Toilet Paper",  9.99);
products[1] = new Product("002", "Pacific Classic Toilet Paper",    13.95);
products[2] = new Product("003", "Envision Toilet Paper",  10.99);
products[3] = new Product("004", "Prank Money Toilet Paper",  7.99);
products[4] = new Product("005", "Cottonelle Toilet Paper",  8.99);
products[5] = new Product("006", "Bounty Paper Towels",  4.99);
products[6] = new Product("007", "Viva Paper Towels",  3.99);
products[7] = new Product("008", "Scott Long Lasting Paper Towels",  8.00);
products[8] = new Product("009", "Sparkle Paper Towels",  5.59);
products[9] = new Product("010", "Eco-Soft Paper Towels",  9.99);
products[10] = new Product("011", "Used Japanese Toilet Paper",  2.99);
products[11] = new Product("012", "Generic Tall Toilet Paper",  3.50);
products[12] = new Product("013", "Nice! Toilet Paper",  3.40);
products[13] = new Product("014", "Box of Green Heritage Toilet Paper",  10.59);
products[14] = new Product("015", "Generic Paper Towels",  2.39);
...
// shipping
var shipping_rate = 5.99;           // will not be applied if free_shipping = true
var free_shipping_allowed = true;   // ship free if spending quota is met
var free_shipping_quota = 40.00     // applied if free_shipping_allowed, set to 0.00 for always free
